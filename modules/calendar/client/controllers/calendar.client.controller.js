...
*/
    ...
    vm.newDate = moment().local().toISOString().split('T')[0];
    ...
    /* add custom event*/
    vm.addEvent = function (choice, classTitle, classStartTime, classEndTime, descr, classStartDate, classEndDate) {
      /*
...
/*
      itemStart = new Date(classStartTime);
      itemEnd = new Date(classEndTime);
*/
      var newEvent = new CalendarService({
        title: classTitle,
        start: classStartDate + 'T' + classStartTime, // vm.selectedDate.local(),
        end: classEndDate + 'T' + classEndTime, // vm.selectedDate.local(),
        startT: classStartTime,
        endT: classEndTime,
        startD: classStartDate,
        endD: classEndDate,
        description: descr,
        className: [color],
        stick: true,
    ...
    */
    ...
    // vm.eventRender = function (ev, CalendarService) {
    //   vm.getPopoverMsg({
    //     title: ev.title,
