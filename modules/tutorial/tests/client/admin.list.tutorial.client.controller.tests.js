(function () {
  ...
  describe('Admin Tutorial List Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _TutorialService_) {
      ...
      $httpBackend.whenGET('/modules/tutorial/client/views/list-tutorial.client.view.html').respond(200, '');
      ...
      TutorialAdminListController = $controller('TutorialAdminListController as vm', {
        $scope: $scope
      });
